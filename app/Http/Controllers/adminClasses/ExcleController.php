...
class ExcleController extends Controller
{
    public function show(){
        ...
        $goods_data=DB::table('goods')->where('goods_info',$input['YP_type'])
            ->where('goods_classes',session("now_classes"))
        ...
        if($input['YP_type']==1){
            return view('Home.AdminClasses/ListGoods',compact('goods_data','TimeData'));
        }else{
            return view('Home.AdminClasses/NomalListGoods',compact('goods_data','TimeData'));
        }
    ...
    {
        $input = Input::except('_token');
        $classes = DB::table("classes")->where("classes_id", session("now_classes"))->where("classes_company", session("now_company"))->value("classes_id");
    ...
    public function adminPeoExcleShow(){
        $classes=DB::table("classes")->where("classes_id",session("now_classes"))->value("classes_id");
