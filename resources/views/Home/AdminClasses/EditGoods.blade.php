...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-responsive-collapse pull-right">
        <ul class="nav navbar-nav">
            <li  class="active"><a href="javascript:;">物资</a></li>
                ...
                <div class="panel panel-default">
                    <div class="panel-body" >
                        ...
                        <form action="{{url('classesadmin/'.$goods->goods_ids)}}" id="form_id" method="post" class="form-horizontal" role="form">
                            ...
                            <input type="hidden" name="goods_account_master" class="form-control goods_account_master"  value="{{$account[0]->admin_classes_name}}"  >
                            <input type="hidden" name="goods_mcmater_master" class="form-control goods_mcmater_master"  value="{{$mcmater[0]->admin_classes_name}}"  >
