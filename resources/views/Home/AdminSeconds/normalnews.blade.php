        ...
        <div class="row">
            ...
            <div  class="col-md-2">
                <ul class="nav nav-pills nav-stacked nav-sidebar" role="tablist" style="background:#F5F5F5;">
                    ...
                    <li><a href="/dangernews">危化品</a></li>
                    <li class="active"><a href="/normalnews">常规品</a></li>
                </ul>
                <br>
                <form action="/normalnews" method="get">
                    <ul class="nav nav-pills nav-stacked nav-sidebar" role="tablist" style="background:#F5F5F5;">
                    ...
                    <div class="panel-body" >
                        ...
                        <div class="form-inline" role="form">
                            ...
                            <form action="#" method="post">
                                ...
                                排序：<select class="form-control" name="desc" >
                                    <option value="时间"
                        ...
                        <div class="list">
                            {!! $NormalData->appends(["KS_select"=>$KSclass["KS_select"]])->appends(["desc"=>$desc['desc']])->links() !!}
                        </div>
                    </div>
                </div>
            </div>
