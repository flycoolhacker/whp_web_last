        ...
        <div class="row">
            ...
            <div  class="col-md-2">
                <ul class="nav nav-pills nav-stacked nav-sidebar" role="tablist" style="background:#F5F5F5;">
                    ...
                    <li class="active"><a href="/classesdangernews">危化品</a></li>
                    <li><a href="/classesnormalnews">常规品</a></li>
                    <li class="active"><a><h4>领用人搜索</h4></a></li>
                        <br>
                        <form action="/searchClassesdangerPerson" method="get">
            ...
            <div class="col-md-10" >
                <div class="panel panel-default">
                    <div class="panel-body" >
                        ...
                        <div class="form-inline" role="form">
                           ...
                           <div class="col-md-4">
                            ...
                            <form action="/classesdangernews" method="post">
                           ...
                           <div class="col-md-8">
                            <form target="_blank" action="logTimeShow" method="get" class="form-inline" role="form">
                    ...
                    <div class="list">
                        ...
                        {{$DangerData->appends(['desc'=>$desc['desc']])->appends(['log_user'=>$userName['log_user']])->links()}}
                        @else
                        {{$DangerData->appends(['desc'=>$desc['desc']])->links()}}
                        @endif
                    </div>
                </div>
            </div>
